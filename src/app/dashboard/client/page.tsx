  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      <div className="mb-8">
        <Link
          href="/events/create"
          className="inline-flex items-center gap-2 bg-[#1E93AB] text-white px-6 py-3 rounded-lg hover:bg-[#197A8F] transition-colors shadow-md hover:shadow-lg"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white p-6 rounded-xl shadow-sm border border-[#DCDCDC] hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              ...
              <div className="w-12 h-12 rounded-full bg-[#1E93AB]/10 flex items-center justify-center">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-[#DCDCDC] hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-[#222222]">0</p>
                <p className="text-xs text-green-600 mt-1">All read</p>
              </div>
              <div className="w-12 h-12 rounded-full bg-[#1E93AB]/10 flex items-center justify-center">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-[#DCDCDC] mb-8">
          <div className="p-6 border-b border-[#DCDCDC]">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-semibold text-[#222222]">Your Events</h2>
          ...
          <div className="p-12">
            <div className="text-center max-w-sm mx-auto">
              ...
              <h3 className="text-lg font-semibold text-[#222222] mb-2">No events yet</h3>
              <p className="text-gray-600 mb-6">Start by posting your first event and find the perfect organizer</p>
              <Link
                href="/events/create"
                className="inline-flex items-center gap-2 bg-[#1E93AB] text-white px-6 py-3 rounded-lg hover:bg-[#197A8F] transition-colors shadow-md hover:shadow-lg"
              >
        ...
        <div className="bg-white rounded-xl shadow-sm border border-[#DCDCDC]">
          ...
          <div className="p-12">
            <div className="text-center max-w-sm mx-auto">
              ...
              <p className="text-gray-600">Organizers will submit proposals once you post an event</p>
            </div>
          </div>
        </div>
      </div>
